...
import type {
  Message, Project, RunMonitor, Session, SettingsData, Task, TaskEvent, View,
} from '../../app/types';
...
export function DashboardWorkspace() {
  ...
  } = useDashboardTelemetry({ api, token, projectId: project?.id, monitoredTaskId, onError: setError });
