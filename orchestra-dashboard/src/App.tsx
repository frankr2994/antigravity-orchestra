...
import { ForgeView } from './components/ForgeView.js';
import { Forge3DView } from './components/Forge3DView.js';

type View = 'dashboard' | 'projects' | 'checkpoints' | 'tasks' | 'mcp' | 'forge' | 'forge3d' | 'settings';
    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav>
          ...
          <NavButton active={view === 'forge'} icon={<Sparkles />} label="Forge Studio" onClick={() => setView('forge')} />
          <NavButton active={view === 'forge3d'} icon={<Box />} label="Forge 3D" onClick={() => setView('forge3d')} />
