...
export const FORGE_DEPENDENCIES: ForgeDependencyItem[] = [
  ...
  },
  {
    ...
    downloadUrl: 'https://huggingface.co/camenduru/FLUX.1-dev/resolve/main/ae.safetensors',
    sizeBytes: 335000000,
  ...
  {
    id: 'sdxl-dreamshaper',
    name: 'SDXL Cinematic & Fantasy (DreamShaper XL Turbo v2)',
    category: 'model',
    targetSubdir: 'models/checkpoints',
    fileName: 'DreamShaperXL_Turbo_v2.safetensors',
    downloadUrl: 'https://huggingface.co/Lykon/dreamshaper-xl-v2-turbo/resolve/main/DreamShaperXL_Turbo_v2.safetensors',
    sizeBytes: 6937648356,
    description: 'Premier turbo checkpoint for rich fantasy art, digital illustration, and cinematic lighting (~6.5 GB VRAM).',
    required: false,
  },
  {
    id: 'sdxl-animagine',
    name: 'SDXL Stylized & Anime (Animagine XL 3.1 SOTA)',
    category: 'model',
    targetSubdir: 'models/checkpoints',
    ...
    sizeBytes: 6937648356,
    description: 'SOTA anime and stylized illustration checkpoint with clean linework and vibrant color (~6.5 GB VRAM).',
    required: false,
  },
  {
    id: 'sdxl-vae',
